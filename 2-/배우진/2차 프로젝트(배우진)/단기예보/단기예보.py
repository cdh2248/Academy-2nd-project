...
def get_request_url(x_coodinate, y_coodinate): # 'http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst'
...
def preprocessed_df_to_oracle(df):
    ...
    for i in range(0, len(df)):
        ...
        cur.execute(sql_insert,
                 (baseDate, fcstDate, fcstTim, fcstValu, nx, ny, PCP, POP, TMP)
                 )
